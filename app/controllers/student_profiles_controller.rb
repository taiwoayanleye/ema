class StudentProfilesController < ApplicationController
  ...
  private
    ...
    def student_profile_params
      params.require(:student_profile).permit(:first_name, :last_name, :school, :email, :expected_graduation, :school_year, :last_completed_degree, :residential_address, :major, :resume, :image)
    end
end
